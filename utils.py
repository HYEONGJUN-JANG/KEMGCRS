...
def parseargs():
    ...
    parser.add_argument("--train_ablation", default='LG', type=str, help="train ablation", choices=['R', 'S', 'RG', 'LG','G'])

    parser.add_argument("--pseudo", action='store_true', help="Whether to Fine-tune on type.")
    parser.add_argument('--pseudo_pos_num', default=4, type=int, help="pseudo_pos_num")
    parser.add_argument('--pseudo_pos_rank', default=4, type=int, help="pseudo_pos_rank")
