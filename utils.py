...
def parseargs():
    ...
    parser.add_argument("--device", default='', type=str, help="GPU Device")  # HJ : Log file middle Name
    ...
    elif sysChecker() == "Windows": pass# HJ local
    else: print("Check Your Platform Setting"); exit()
    return args
