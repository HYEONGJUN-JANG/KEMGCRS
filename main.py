...
def main():
    ...
    if 'know' in args.task:
        ...
        if args.stage == 'rerank':
            args.stage = 'retrieve'
            eval_know(args, train_dataloader_retrieve, retriever, knowledge_data, knowledgeDB, tokenizer, retrieve=True)  # HJ: Knowledge text top-k 뽑아서 output만들어 체크하던 코드 분리
